<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="positionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位职责描述" align="center" prop="remark" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="positionRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位职责描述" prop="remark">
          <el-input v-model="form.remark" placeholder="请输入岗位职责描述" />
        </el-form-item>
      </el-form>
      <template #footer>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除岗位编号为"' + _ids + '"的数据项？').then(function() {
